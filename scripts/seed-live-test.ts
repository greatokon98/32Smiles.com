...
async function main() {
  console.log("🌱 Seeding live test database (Nigeria / NGN)...")
  ...
  const accounts: { email: string; password: string; name: string; role: string; phone?: string; address?: string }[] = [
    { email: "superadmin@demo.local", password: "Superadmin123!", name: "Super Admin", role: "SUPER_ADMIN", phone: "+2348011223344", address: "12, Adeola Odeku Street, Victoria Island, Lagos" },
    { email: "admin@demo.local", password: "Admin123!", name: "Clinic Admin", role: "ADMIN", phone: "+2348011223344", address: "12, Adeola Odeku Street, Victoria Island, Lagos" },
    { email: "editor@demo.local", password: "Editor123!", name: "Content Editor", role: "EDITOR", phone: "+2348011223344", address: "12, Adeola Odeku Street, Victoria Island, Lagos" },
    { email: "receptionist@demo.local", password: "Receptionist123!", name: "Receptionist", role: "RECEPTIONIST", phone: "+2348011223344", address: "12, Adeola Odeku Street, Victoria Island, Lagos" },
    { email: "patient@demo.local", password: "Patient123!", name: "Demo Patient", role: "VIEWER", phone: "+2348011223344", address: "12, Adeola Odeku Street, Victoria Island, Lagos" },
  ]
  ...
  const settings = [
    ...
    { key: "site.tagline", value: "Best Dental Clinic in Lagos", group: "general", label: "Tagline" },
    { key: "site.description", value: "Multi-speciality dental care in Lagos, Nigeria. Root canals, dental implants, Invisalign, laser dentistry and more.", group: "general", label: "Site Description" },
    { key: "contact.phone", value: "+234-8011223344", group: "contact", label: "Phone Number" },
    { key: "contact.email", value: "appointments@32smilesdemo.local", group: "contact", label: "Email Address" },
    { key: "contact.address", value: "Victoria Island, Lagos, Nigeria", group: "contact", label: "Address" },
    ...
    { key: "seo.defaultTitle", value: "32 Smiles Multispeciality Dental Clinics | Best Dental Clinic in Lagos", group: "seo", label: "Default Meta Title" },
    { key: "seo.defaultDescription", value: "32 Smiles is a leading multi-speciality dental clinic in Lagos, Nigeria. Root canals, implants, Invisalign, laser dentistry, child dental care and more.", group: "seo", label: "Default Meta Description" },
  ...
  // ── 9. Product categories + products (NGN shop) ────────────────────
  ...
  const products = [
    { title: "Fluoride Toothpaste 100g", slug: "fluoride-toothpaste-100g", category: "toothpaste", price: 2500, brand: "Colgate", rating: 4.6, reviewCount: 184, featured: true, hot: false, sale: false, desc: "Daily fluoride toothpaste that fights cavities, strengthens enamel and protects against plaque." },
    { title: "Whitening Toothpaste 100g", slug: "whitening-toothpaste-100g", category: "toothpaste", price: 3500, brand: "Sensodyne", rating: 4.5, reviewCount: 96, featured: false, hot: false, sale: true, desc: "Gentle whitening paste that lifts surface stains while protecting sensitive teeth." },
    { title: "Kids Toothpaste 50g", slug: "kids-toothpaste-50g", category: "kids", price: 2000, brand: "Colgate", rating: 4.7, reviewCount: 73, featured: false, hot: false, sale: false, desc: "Low-fluoride, mild-tasting toothpaste made for children's developing teeth." },
    { title: "Soft-Bristled Toothbrush", slug: "soft-bristled-toothbrush", category: "brushes", price: 1800, brand: "Oral-B", rating: 4.4, reviewCount: 210, featured: true, hot: false, sale: false, desc: "Soft, end-rounded bristles that clean gently without damaging gums." },
    { title: "Sonic Electric Toothbrush", slug: "sonic-electric-toothbrush", category: "brushes", price: 35000, brand: "Philips", rating: 4.8, reviewCount: 64, featured: true, hot: true, sale: false, desc: "Sonic cleaning with a smart timer and pressure sensor for a dentist-grade clean." },
    { title: "Kids Cartoon Toothbrush", slug: "kids-cartoon-toothbrush", category: "kids", price: 2200, brand: "Oral-B", rating: 4.6, reviewCount: 58, featured: false, hot: false, sale: false, desc: "Small-headed brush with fun characters that makes brushing a habit kids enjoy." },
    { title: "Alcohol-Free Mouthwash 250ml", slug: "alcohol-free-mouthwash-250ml", category: "mouthwash", price: 4000, brand: "Listerine", rating: 4.5, reviewCount: 132, featured: true, hot: false, sale: false, desc: "Alcohol-free rinse that kills odour-causing bacteria without the burn." },
    { title: "Herbal Mouthwash 250ml", slug: "herbal-mouthwash-250ml", category: "mouthwash", price: 3000, brand: "Dabur", rating: 4.3, reviewCount: 88, featured: false, hot: false, sale: true, desc: "Ayurvedic herbal rinse for fresh breath and healthy gums, suitable for daily use." },
    { title: "Dental Floss 50m", slug: "dental-floss-50m", category: "accessories", price: 2500, brand: "Oral-B", rating: 4.4, reviewCount: 145, featured: false, hot: false, sale: false, desc: "Waxed, shred-resistant floss that reaches the spaces a brush cannot." },
    { title: "Interdental Brushes (Pack of 10)", slug: "interdental-brushes-pack-10", category: "accessories", price: 4500, brand: "TePe", rating: 4.7, reviewCount: 41, featured: false, hot: false, sale: false, desc: "Fine brushes for cleaning between teeth and around crowns and braces." },
    { title: "Tongue Cleaner", slug: "tongue-cleaner", category: "accessories", price: 1500, brand: "DentaCare", rating: 4.2, reviewCount: 167, featured: false, hot: false, sale: false, desc: "Stainless steel tongue cleaner to remove bacteria and freshen breath." },
  ]
  ...
  const templates = [
    {
      ...
      systemPrompt: "You are a professional dental content writer for 32 Smiles Multispeciality Dental Clinics in Lagos, Nigeria.",
    },
    {
  ...
  await prisma.appointment.upsert({
    where: {
      id: "demo-appointment-lagos",
    },
    update: {
      patientName: "Demo Patient",
      patientEmail: patientUser.email,
      patientPhone: "+234-9000000000",
