...
async function main() {
  ...
  const imageSettings = [
    ...
    { key: "blog_fallback_images", value: JSON.stringify(["/images/blog/1.jpg", "/images/blog/2.jpg", "/images/blog/3.jpg", "/images/blog/4.jpg", "/images/blog/5.jpg"]), group: "images", label: "Blog Fallback Images" },
